...
from accounts.forms import SignUpForm, SignInViaEmailForm, CustomPasswordResetForm, AccountProfileForm
from accounts.models import Activation, Profile
...
class AccountProfileView(LoginRequiredMixin, UpdateView):
    ...
    error_message = 'There is a technical problem, please try again later'
