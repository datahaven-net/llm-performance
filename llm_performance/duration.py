...
_nanosecond_size  = 1
_microsecond_size = 1000.0 * _nanosecond_size
_millisecond_size = 1000.0 * _microsecond_size
_second_size      = 1000.0 * _millisecond_size
_minute_size      = 60.0   * _second_size
_hour_size        = 60.0   * _minute_size
_day_size         = 24.0   * _hour_size
_week_size        = 7.0    * _day_size
_month_size       = 30.0   * _day_size
_year_size        = 365.0  * _day_size
...
def from_str(duration):
    """Parse a duration string to seconds in float value"""
...
def to_str(total_seconds, extended=False):
    """Format a float value to a duration string"""
